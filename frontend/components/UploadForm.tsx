...
import { Calendar, Tag, Location } from "@carbon/icons-react";

const MapPicker = dynamic(() => import("@/components/MapPicker"), {
  ssr: false,
  loading: () => (
    <div className="h-[300px] w-full bg-gray-100 rounded-xl flex items-center justify-center text-gray-500 animate-pulse">
      Učitavanje mape...
    </div>
  )
});
      ...
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="title" className="font-bold">Naslov videa</Label>
            <Input
              id="title"
              name="title"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
                <Label htmlFor="tags" className="flex items-center gap-2 font-bold">
                    <Tag /> Tagovi
                </Label>
                <Input
                    id="tags"
            ...
            <div className="space-y-2">
                <Label htmlFor="premieresAt" className="flex items-center gap-2 font-bold">
                ...
                <Input
                    ...
                    disabled={isSubmitting}
                />
                <p className="text-xs text-gray-500">Video će biti skriven do ovog datuma.</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            {location ? (
                <div className="flex items-center justify-between text-sm bg-green-50 text-green-700 p-2 rounded-md border border-green-200">
                    <span> Odabrano: {location.lat.toFixed(5)}, {location.lng.toFixed(5)}</span>
                    <Button
                        type="button"
                        variant="ghost"
                        size="sm"
                ...
                <p className="text-xs text-gray-500">Kliknite na mapu da označite lokaciju.</p>
            )}
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="space-y-2">
                <Label htmlFor="videoFile" className="font-bold">Video fajl (MP4)</Label>
                <Input
                  id="videoFile"
                  name="videoFile"
                  type="file"
            ...
            <div className="space-y-2">
                <Label htmlFor="thumbnailFile" className="font-bold">Sličica (Thumbnail)</Label>
                <Input
                  id="thumbnailFile"
                  name="thumbnailFile"
                  type="file"
        ...
        <CardFooter className="flex justify-end pt-2 pb-6 px-6">
          <Button type="submit" size="lg" disabled={isSubmitting} className="w-full md:w-auto font-bold">
